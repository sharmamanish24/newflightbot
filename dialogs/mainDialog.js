...
const { MessageFactory, InputHints, EventFactory } = require('botbuilder');
const { ActivityEx } = require('botframework-schema');
const { LuisRecognizer } = require('botbuilder-ai');
const { ActivityTypes, Attachment } = require('botframework-schema');


const { ComponentDialog, DialogSet, DialogTurnStatus, TextPrompt, WaterfallDialog } = require('botbuilder-dialogs');
const moment = require('moment-timezone');

const { uuidV4, insertDataTataDb } = require('../utils/dbUtils');

const MAIN_WATERFALL_DIALOG = 'mainWaterfallDialog';

class MainDialog extends ComponentDialog {
    constructor(luisRecognizer, bookingDialog, transcriptStore) {
        super('MainDialog');
